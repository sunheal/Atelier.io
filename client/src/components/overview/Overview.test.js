...
describe('Overview', () => {
  it('should redner correct product info1', () => {
    const productInfo = {
      "id": 64620,
      "campus": "hr-rpp",
      "name": "Camo Onesie",
    ...
    render(<Overview productInfo={productInfo} productID={productID} productStyle={productStyle} />);
    const productName = screen.getByText('Camo Onesie');
    expect(productName).toBeInTheDocument();
  })

  it('should redner correct product info2', () => {
    const productInfo = {
      "id": 64620,
      "campus": "hr-rpp",
      "name": "Camo Onesie",
  ...
  it('should redner correct product info3', () => {
    const productInfo = {
      "id": 64620,
      "campus": "hr-rpp",
      "name": "Camo Onesie",
  ...
  it('should redner correct product info4', () => {
    const productInfo = {
      "id": 64620,
      "campus": "hr-rpp",
      "name": "Camo Onesie",
